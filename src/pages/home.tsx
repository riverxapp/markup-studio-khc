...
export function Home() {
  return (
    <main className="min-h-screen bg-[#fff7ec] flex flex-col">
      {/* HERO */}
      <header
        className="relative w-full text-center px-4 pt-10 pb-12 md:pt-16 md:pb-20 overflow-hidden bg-gradient-to-b from-[#ffe3ba] to-[#fff7ec]"
      ...
      >
        <div className="max-w-3xl mx-auto">
          <img
            ...
            alt="Restaurant Dish"
            className="rounded-xl shadow-lg w-full h-56 sm:h-72 md:h-80 object-cover mb-6 border-4 border-[#f6e0c6]"
            loading="eager"
          />
          <p className="text-xs font-semibold uppercase tracking-[0.17em] text-[#d94828] mb-2">
            Now Open in Your City
          </p>
          <h1 className="text-4xl sm:text-5xl font-bold tracking-tight text-[#26170e] mb-4 drop-shadow">
            Savour.&nbsp; {env.appName || "The Gourmet Kitchen"}
          </h1>
          <p className="max-w-xl mx-auto text-lg sm:text-xl leading-relaxed text-[#6f5b4a] mb-8">
          ...
          <div className="flex flex-wrap items-center justify-center gap-3">
            <Button asChild size="lg" className="bg-[#ff6b4a] px-8 text-white hover:bg-[#d94828] shadow-lg transition">
            ...
            <Button
              ...
              variant="outline"
              size="lg"
              className="border-[#e7cdb4] bg-[#fffaf2] px-8 text-[#26170e] hover:bg-[#ffe7cf] transition"
            >
      ...
      {/* FEATURES */}
      <section
        className="max-w-6xl mx-auto w-full px-4 py-10 md:py-16 grid gap-8 md:grid-cols-3"
        aria-labelledby="cuisine-features"
      >
        <Card className="border-[#f1ddc9] bg-[#fffaf2] flex flex-col h-full">
          <CardHeader>
            <CardTitle className="flex items-center gap-3 text-2xl text-[#d94828]">
              <span role="img" aria-label="Plate">🍽️</span> Artisanal Cuisine
            </CardTitle>
            <CardDescription className="text-[#6f5b4a]">
              A seasonal menu curated by award-winning chefs using farm-fresh ingredients.
            </CardDescription>
          </CardHeader>
          <CardContent className="grow text-[#6f5b4a] text-base">
            Signature dishes, inventive pairings, and flair you won't find elsewhere. Elegant plates, creative flavors.
          </CardContent>
        </Card>
        <Card className="border-[#f1ddc9] bg-[#fffaf2] flex flex-col h-full">
          <CardHeader>
            <CardTitle className="flex items-center gap-3 text-2xl text-[#d94828]">
              <span role="img" aria-label="Glass">🍷</span> Curated Beverage
            </CardTitle>
            <CardDescription className="text-[#6f5b4a]">
              Handpicked wine lists, craft cocktails, and zero-proof delights.
            </CardDescription>
          </CardHeader>
          <CardContent className="grow text-[#6f5b4a] text-base">
            Our sommeliers have created a beverage experience to match every mood.
          </CardContent>
        </Card>
        <Card className="border-[#f1ddc9] bg-[#fffaf2] flex flex-col h-full">
          <CardHeader>
            <CardTitle className="flex items-center gap-3 text-2xl text-[#d94828]">
              <span role="img" aria-label="Leaf">🌱</span> Inviting Atmosphere
            </CardTitle>
            <CardDescription className="text-[#6f5b4a]">
              Modern interiors, lush greenery, private dining & full accessibility.
            </CardDescription>
          </CardHeader>
          <CardContent className="grow text-[#6f5b4a] text-base">
            Perfect for romantic dinners, business meetings, or family celebrations.
          </CardContent>
        </Card>
      </section>
      ...
      {/* TESTIMONIALS */}
      <section
        className="w-full py-12 bg-gradient-to-br from-[#fff2e5] to-[#fff7ec]"
      ...
      >
        <div className="max-w-5xl px-4 mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <Card className="border-[#f6e0c6] bg-white">
      ...
      <section
        id="menu"
        className="py-16 px-4 w-full bg-[#fffaf2] border-y border-[#f1ddc9]"
        aria-labelledby="menu-highlight"
      >
        <div className="max-w-4xl mx-auto">
          <h2 id="menu-highlight" className="text-2xl sm:text-3xl font-bold mb-6 text-center text-[#26170e]">
            Featured Menu
          </h2>
          <ul className="grid gap-8 md:grid-cols-2">
            <li className="flex gap-4 items-start">
              ...
              <div>
                <h3 className="font-semibold text-[#d94828] text-lg">Truffle Wild Mushroom Risotto</h3>
            ...
            <li className="flex gap-4 items-start">
              ...
              <div>
                <h3 className="font-semibold text-[#d94828] text-lg">Citrus Seared Salmon</h3>
                <p className="text-[#6f5b4a] text-sm">
            ...
            <li className="flex gap-4 items-start">
              ...
              <div>
                <h3 className="font-semibold text-[#d94828] text-lg">Handmade Ricotta Ravioli</h3>
                <p className="text-[#6f5b4a] text-sm">
            ...
            <li className="flex gap-4 items-start">
              ...
              <div>
                <h3 className="font-semibold text-[#d94828] text-lg">Molten Chocolate Lava Cake</h3>
                <p className="text-[#6f5b4a] text-sm">
          ...
          <div className="flex justify-center mt-8">
            <Button asChild size="lg" className="bg-[#ff6b4a] px-10 text-white hover:bg-[#d94828] shadow-lg transition">
              <Link to="/">Book a Table</Link>
            </Button>
          </div>
        </div>
      ...
      <footer className="w-full bg-[#26170e] text-[#fff7ec] pt-12 pb-8 mt-auto" aria-label="Footer">
        <div className="max-w-6xl px-4 mx-auto grid gap-6 sm:grid-cols-2 md:grid-cols-4">
          ...
          <div>
            ...
            <a href="tel:+1234567890" className="text-[#fff7ec] hover:underline block text-sm">
              (123) 456-7890
            </a>
            <a
              href="mailto:hello@gourmetkitchen.com"
              className="text-[#fff7ec] hover:underline text-sm"
            >
